...
public class SaveK2000Method extends K2x00FileMethod {
	...
	public javax.swing.filechooser.FileFilter getFileFilter() {
		return new javax.swing.filechooser.FileFilter() {
			public boolean accept(File f) {
				...
				if (name.toUpperCase().endsWith(".KRZ")) //$NON-NLS-1$
					return true;

				return false;
			}
			public String getDescription() {
				return Messages.getString("SaveK2000Method.Kurzweil_K2000_File_(.krz)"); //$NON-NLS-1$
			}
		};
	}

	public String getFileTypeDescription() {
		return Messages.getString("SaveK2000Method.Name"); //$NON-NLS-1$
	}
}
