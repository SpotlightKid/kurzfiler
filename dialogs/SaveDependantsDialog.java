...
public class SaveDependantsDialog
extends YesNoCancelDialog
{
	...
	static final String myName = Messages.getString("SaveDependantsDialog.Titel"); //$NON-NLS-1$

	public SaveDependantsDialog(Frame parent)
	{
		super(parent,myName);
  	}
	...
	protected void customizeLayout(JPanel panel)
	{
		...
		JLabel label= new JLabel(Messages.getString("SaveDependantsDialog.Frage")); //$NON-NLS-1$
		panel.add(label);
	}
